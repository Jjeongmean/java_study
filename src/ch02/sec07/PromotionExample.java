...
public class PromotionExample {
    public static void main(String[] args) {
        ...
        int intValue = byteValue; //자동타입 변환 ➡ intValue의 10dms int타입으로 저장된다.
        System.out.println("intValue: " + intValue);

        intValue = 50; //int 타입
        long longValue = intValue; // 자동타입변환 ➡ 50은 long타입으로 저장된다.
        System.out.println("intValue: " + intValue);

        short shortValue = 10;
        int intValue2 = shortValue; // 자동타입변환 ➡ short 타입이었던 10은 int타입으로 저장된다.

        //⭐정수보다 실수의 허용범위가 더 큼 ➡ 정수에서 실수로 자동타입변환이 일어난다
        byte longValue2 = 100; // = long longValue2 = 100L;
        ...
        //char ➡ int 타입 변환: 유니코드가 정수로 표현 가능하기 때문에
        char charValue = '가';
